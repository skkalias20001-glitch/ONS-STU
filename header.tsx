...
const socialLinks = [
  { href: "https://www.youtube.com/@Onshore5446", icon: Youtube, label: "YouTube" },
  { href: "https://discord.com/invite/Fds6u9Jpb6", icon: DiscordIcon, label: "Discord" },
  { href: "https://www.instagram.com/onshore.5446yt/", icon: Instagram, label: "Instagram" },
];
    ...
    <footer className="border-t border-border bg-card/50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Epic Minecraft and Roblox content for gamers everywhere.
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-border text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Onshore Studios. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
